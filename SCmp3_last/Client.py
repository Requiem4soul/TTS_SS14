...
def play_audio(file_path):
    ...
    while pygame.mixer.music.get_busy():
        pygame.time.Clock().tick(1)  # Ждем завершения воспроизведения
...
def receive_audio(data):
    ...
    if audio_data:
        ...
        audio_file_name = f'received_audio{current_audio_index:03d}.mp3'
        ...
        if current_audio_index >= 3:
            prev_audio_index = current_audio_index - 2
            prev_audio_file_name = f'received_audio{prev_audio_index:03d}.mp3'
